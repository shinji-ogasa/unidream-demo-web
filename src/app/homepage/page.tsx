        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-8 py-10 md:py-16 w-full">
          <div className="max-w-[760px]">
            ...
            <motion.h1
              ...
              className="text-[clamp(2.4rem,7vw,5rem)] md:text-[clamp(2.4rem,5vw,4.2rem)] font-semibold tracking-[-0.04em] md:tracking-[-0.05em] leading-[1.15] md:leading-[1.04] text-[#f4f7fb]"
            >
