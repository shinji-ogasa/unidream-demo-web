    ...
    <main className="site-bg min-h-screen text-[#f4f7fb] antialiased">
      ...
      <section className="container-site py-8 md:py-10">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-4 md:gap-8">
          <AnimateInView className="flex-1 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 flex flex-col justify-start" x={-16} y={0}>
          ...
          <AnimateInView className="flex-1 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 flex flex-col justify-start" x={16} y={0} delay={0.15}>
