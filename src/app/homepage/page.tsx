...
const METRICS = [
  ...
  { label: "Scale", value: "0-12 Fold 完走", sub: "全foldでMaxDD改善", color: "text-[#4ade80]" },
      ...
      <section className="container-site py-12 md:py-16 pb-8 md:pb-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.3fr_1fr]">
          <AnimateInView className="card p-8 md:p-10 border-[rgba(94,106,210,0.36)]" x={-20} y={0}>
            ...
            <p className="mt-5 text-sm text-[#626b7a] leading-5">全foldでMaxDD改善。最悪foldでも−1.28pt、大きく壊れるfoldなし。低回転で安定したB&Hオーバーレイ。</p>
          </AnimateInView>
