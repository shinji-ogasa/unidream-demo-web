...
const migrations=await Promise.all(['20260906054107_btc_research_demo.sql','20260906073004_wm_research_demo.sql','20260906132408_wm_historical_backfill.sql'].map(async name=>({name,body:await readFile(new URL('../migrations/'+name,import.meta.url),'utf8')})));
const cases=[];
